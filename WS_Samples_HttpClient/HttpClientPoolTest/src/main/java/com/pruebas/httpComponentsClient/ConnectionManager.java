...
public class ConnectionManager {
    ...
    public static String printConnectionConfig() {
        ...
        /*
         * sf.append(" - poolStats.getAvailable() = "+poolStats.getAvailable()); sf.append(" - poolStats.getLeased() = "
         * +poolStats.getLeased()); sf.append(" - poolStats.getMax() = "+poolStats.getMax()); sf.append(
         * " - poolStats.getPending() = "+poolStats.getPending());
         */
